                                ...
                                for ($i = 0; $i < $vigencia->numero_parcelas; $i++) {
                                    ...
                                    <div class="row linhaParcela">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="text" id="valor<?= $i ?>" name="valor[]" onKeyPress="return(moeda(this,'.',',',event))" value="<?= $vigenciaObj->dinheiroParaBr($parcela_vigencia[$i]->valor) ?? "" ?>" class="form-control valor">
                                        </div>
