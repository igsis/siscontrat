                                ...
                                method="POST" role="form" data-form="<?= ($id) ? "update" : "save" ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-2">
                                            ...
                                            <input type="number" class="form-control" id="numero_parcelas" name="quantidade_parcelas"
                                    ...
                                    <?php if ($id): ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-2">
                                                ...
                                                <input type="text" id="valor<?= $i ?>" name="valor[]" onKeyPress="return(moeda(this,'.',',',event))"
