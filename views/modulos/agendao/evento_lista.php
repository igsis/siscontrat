...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-3">
                <a href="<?= SERVERURL ?>agendao/evento_cadastro"><button class="btn btn-success btn-block">Adicionar</button></a>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <div class="col">
                                                <a href="<?=SERVERURL."agendao/evento_cadastro&key=".$eventoObj->encryption($evento->id)?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i> Editar</a>
                                            </div>
                                            <div class="col">
