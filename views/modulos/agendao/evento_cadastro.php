...
if ($oficina) {
    $_SESSION['atracao_id_s'] = $oficinaObj->encryption($oficina->atracao_id);
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Cadastro do Agendão</h1>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <input type="text" class="form-control" id="nomeEvento" name="ev_nome_evento"
                                       placeholder="Digite o nome do evento. Exemplo: Show da Banda XYZ"
