...
$pdf->SetX($x);
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(180, $l, utf8_decode("São Paulo, _________ de _____________________________ de ") . date('Y') . ".", 0, 0, 'L');
...
$pdf->SetX($x);
$pdf->SetFont('Arial', '', 10);
$pdf->Cell(100, 4, $documento, 0, 1, 'L');
